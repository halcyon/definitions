...
# Required until https://bugs.launchpad.net/ubuntu/+source/grub2/+bug/761830 is resolved
sed -i '67,71s/^/#/' /etc/grub.d/10_linux; grub-mkconfig -o /boot/grub/grub.cfg; grub-setup /dev/sda
